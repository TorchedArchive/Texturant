        ...
        if(c.mb_foodcategory === "Breakfast") {
            inquirer.prompt({
                ...
                choices: [
                    ...
                    "Egg Mickey Muffin",
                    "Egg White Delight Mickey Muffin",
                    "Sausage Mickey Muffin", 
                    "Sausage Mickey Muffin With Egg",
                ...
                if(cc.mb_breakfast.length === 0) {
                    ...
                    console.log(`Susan > Getting ready to deliver your ${cc.mb_breakfast.length > 1 ? `${cc.mb_breakfast.slice(0, cc.mb_breakfast.length - 1).join(", ")} and ${cc.mb_breakfast.slice(-1).pop()}` : cc.mb_breakfast.join(", ")}.`)
                    setTimeout(() => {
                        console.log("Texturant > Your items have been delivered!")
                    }, 5000)
                }
            })
        }
